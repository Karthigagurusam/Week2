...
public class Facebook {
	...
	public static void main(String[] args) {
		...
		//Mobile number
		driver1.findElement(By.xpath("//input[@name='reg_email_id']")).sendKeys("gkarthigaguru@gmail.com");
	...
	driver1.findElement(By.xpath("//input[@aria-label = 'Re-enter email address']")).sendKeys("gkarthigaguru@gmail.com");
